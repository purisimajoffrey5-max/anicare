...
<header class="topbar">
    <div class="topbar-inner">
        ...
        <div class="actions-top">
            ...
            <a
                href="{{ route('admin.milling.create') }}"
        ...
        <article class="request-card">
            ...
            <div class="head">
                ...
                <div>
                    <div class="request-id">
                        Milling Request #{{ $request->id }}
                    </div>

                    <div class="miller-name">
                        {{ $request->miller?->fullname
            ...
            <div class="info-grid">
                ...
                <div class="info">
                    ...
                    <div class="value">
                        {{ strtoupper($request->payment_status ?? 'unpaid') }}
                    </div>
                </div>
            ...
            <div class="card-actions">
                ...
                <a
                    href="{{ route('admin.milling.show', $request->id) }}"
                ...
                @if(in_array($status, ['pending','accepted','scheduled'], true))
                    ...
                    <form
                        method="POST"
                        action="{{ route('admin.milling.cancel', $request->id) }}"
                        class="m-0"
                    >
                        @csrf
