...
<head>
    ...
    <style>
        * {
        ...
        /*
         * HIDDEN LEAFLET MAP
         * The map stays alive off-screen so geocoding, routing,
         * distance calculation, and shipping-fee computation still work.
         */
        #routeMapSection {
...
<div class="checkout-container">
    ...
    <div class="card checkout-card">
        <div class="card-body p-4">
            ...
            <form method="POST"
                  action="{{ route('resident.checkout.place', $product->id) }}"
                  id="checkoutForm">
                    ...
                    <div class="col-12"
                        ...
                        @else
                            <div class="form-text text-danger">
                                ...
                                Buyer address is not available. Update your profile first.
                            </div>
                        @endif
    ...
    */
    ...
    async function showLocationsOnMap(farmerLocation, buyerLocation) {
        ...
        buyerMarker = L.marker(buyerLatLng)
            .addTo(routeMap)
            .bindPopup('<strong>Buyer / Delivery</strong><br>' + BUYER_ADDRESS);
        ...
        */
        ...
        if (deliveryOption.checked) {
            ...
            if (
                ...
                alert(
                    'Your delivery address is unavailable. Please update your profile first.'
                );
