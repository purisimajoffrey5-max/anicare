...
<main class="wrap">
    <div class="d-flex justify-content-between align-items-center gap-2 mb-3">
        <div>
            ...
            <div class="text-muted small">
                <?php echo e($unreadCount); ?> unread notification<?php echo e($unreadCount === 1 ? '' : 's'); ?>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <a
            href="<?php echo e(route('notifications.open', $notification->id)); ?>"
            class="notif-card <?php echo e(!$notification->is_read ? 'unread' : ''); ?>"
        >
            <div class="notif-icon">
                <i class="bi <?php echo e($notification->icon ?: 'bi-bell-fill'); ?>"></i>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Allacapan_Anicare\resources\views/notifications/index.blade.php ENDPATH**/ ?>