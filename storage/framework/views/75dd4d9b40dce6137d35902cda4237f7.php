    ...
    *, *::before, *::after { box-sizing: inherit; }
    ...
    <style>
        ...
        .hero {
            ...
            url('<?php echo e(asset("images/hero-rice.jpg")); ?>') center/cover no-repeat;
            min-height: 90vh;
            display: flex;
            align-items: center;
            color: #fff;
...
<body>
    <?php echo $__env->make('components.landing-splash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div id="nav" class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
                ...
                <li class="nav-item ms-lg-2">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-warning btn-sm">Login</a>
                </li>
            </ul>
        </div>
    </div>
...
<section id="home" class="hero">
    <div class="container">
        ...
        <div class="mt-4">
            <a href="<?php echo e(route('login')); ?>" class="btn btn-warning btn-lg me-2">Login</a>
...
<section class="py-5 bg-white">
    <div class="container">
        <div class="row align-items-center g-4">
            ...
            <div class="col-lg-6">
                <img
                    src="<?php echo e(asset('images/farmer.jpg')); ?>"
                    alt="ANI-CARE Farmer"
            ...
            <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4">
                    <div class="card feature-card h-100 p-3">
                        <h5 class="fw-bold text-success"><?php echo e($f[0]); ?></h5>
                        <p class="text-muted mb-0"><?php echo e($f[1]); ?></p>
                    </div>
                </div>
...
<footer id="contact" class="py-4">
    <div class="container text-center">
        ...
        <small>© <?php echo e(date('Y')); ?> All Rights Reserved | Allacapan, Cagayan</small>
    </div>
</footer>
...
<?php /**PATH C:\xampp\htdocs\Allacapan_Anicare\resources\views/pages/welcome.blade.php ENDPATH**/ ?>