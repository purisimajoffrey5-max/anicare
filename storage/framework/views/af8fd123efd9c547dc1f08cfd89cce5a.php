...
<header class="topbar">
    ...
    <div class="topbar-inner">
        ...
        <div class="top-actions">
            ...
            <a
                href="<?php echo e(route('farmer.orders.index')); ?>"
...
<main class="page-wrap">
    ...
    <section class="welcome-box">
        ...
        <h1 class="welcome-title">
            ...
            <span class="welcome-name">
                <?php echo e(Auth::user()->fullname ?? 'Farmer'); ?>
    ...
    <section class="dashboard-grid">
        ...
        <a
            href="<?php echo e(route('farmer.profile')); ?>"
        ...
        <a
            href="<?php echo e(route('farmer.milling.create')); ?>"
            class="dashboard-link"
        >
        ...
        <a
            href="<?php echo e(route('farmer.milling.index')); ?>"
            class="dashboard-link"
        >
        ...
        <a
            href="<?php echo e(route('farmer.products.create')); ?>"
            class="dashboard-link"
        >
        ...
        <a
            href="<?php echo e(route('farmer.products.index')); ?>"
            class="dashboard-link"
        >
        ...
        <a
            href="<?php echo e(route('farmer.earnings.index')); ?>"
            class="dashboard-link"
        >
        ...
        <section class="announcement-section">
            ...
            <div class="section-heading">
                ...
                <span class="section-badge">
                    ...
                    Update<?php echo e($announcements->count() === 1 ? '' : 's'); ?>
                ...
                <article class="announcement-card">
                    ...
                    <div class="card-body">
                        ...
                        <small class="text-muted">
                            ...
                            <?php echo e($a->created_at?->format('F d, Y • h:i A')); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Allacapan_Anicare\resources\views/dashboards/farmer.blade.php ENDPATH**/ ?>