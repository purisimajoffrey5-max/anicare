...
<header class="topbar">
    <div class="topbar-inner">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('admin.milling.index')); ?>" class="btn btn-outline-light btn-sm">
                <i class="bi bi-clipboard-check"></i>
                <span>My Requests</span>
            </a>

            <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-warning btn-sm">
...
<main class="page">
    ...
    <form method="POST" action="<?php echo e(route('admin.milling.store')); ?>" id="adminMillingForm">
        <?php echo csrf_field(); ?>

        <input type="hidden" name="quantity_kilos" id="quantity_kilos" value="<?php echo e(old('quantity_kilos')); ?>">
        <input type="hidden" name="quantity_value" id="quantity_value" value="<?php echo e(old('quantity_value')); ?>">
        ...
        <section class="card-box">
            ...
            <input type="hidden" name="miller_id" id="miller_id" value="<?php echo e(old('miller_id')); ?>" required>
            ...
            <div class="quantity-grid">
                ...
                <div>
                    ...
                    <select name="quantity_unit" id="quantity_unit" class="form-select" required>
                        <option value="kg" <?php echo e(old('quantity_unit', 'kg') === 'kg' ? 'selected' : ''); ?>>
                            Kilogram (kg)
                        </option>

                        <option value="sack" <?php echo e(old('quantity_unit') === 'sack' ? 'selected' : ''); ?>>
                            Sack / Cavan
                        </option>
                    </select>
                </div>
            ...
            <div class="transport-grid">
                ...
                <label class="transport-option">
                    <input
                        ...
                        value="delivery"
                        <?php echo e(old('transport_type', 'delivery') === 'delivery' ? 'checked' : ''); ?>
                ...
                <label class="transport-option">
                    <input
                        ...
                        id="transportPickup"
                        value="pickup"
                        <?php echo e(old('transport_type') === 'pickup' ? 'checked' : ''); ?>
            ...
            <div class="address-box mt-2" id="transportAddressBox">
                ...
                <?php echo e($adminAddress !== '' ? $adminAddress : 'No registered address found.'); ?>
            ...
            <div class="cost-card">
                ...
                <?php if($vatEnabled): ?>
                    ...
                    <div class="cost-row vat-summary-row">
                        <span>VAT (<?php echo e(number_format((float)$vatRate, 2)); ?>%)</span>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="preferred_date"
                        class="form-control"
                        min="<?php echo e(now('Asia/Manila')->format('Y-m-d')); ?>"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="miller-list">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = ($millers ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $miller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

                        <div
                            class="miller-item"
                            data-search="<?php echo e(strtolower(($miller->fullname ?? '').' '.($miller->username ?? ''))); ?>"
                        >
                            <div>
                                <div class="miller-name">
                                    <?php echo e($miller->fullname ?? $miller->username ?? 'Miller'); ?>

                                </div>

                                <div class="miller-user">
                                    <?php echo e(!empty($miller->username) ? '@'.$miller->username : ''); ?>

                                    • Barangay:
                                    <strong><?php echo e($miller->barangay ?: 'Not set'); ?></strong>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <button
                                    ...
                                    onclick="selectMillerById(<?php echo e($miller->id); ?>)"
                                >
                                    Select
                                </button>
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const VAT_ENABLED = <?php echo json_encode($vatEnabled, 15, 512) ?>;
    const VAT_RATE = <?php echo json_encode((float) $vatRate, 15, 512) ?> / 100;
    ...
    const ADMIN_ADDRESS =
        <?php echo json_encode($adminAddress, 15, 512) ?>;

    const millers =
        <?php echo json_encode($millerJsData, 15, 512) ?>;
    ...
    const MILLER_LOCATION_URL_TEMPLATE =
        <?php echo json_encode(route('admin.milling.millerLocation', ['id' => '__ID__']), 512) ?>;
    ...
    */
    ...
    const oldQuantityKilos =
        Number(
            <?php echo json_encode((float) old('quantity_kilos', 0), 512) ?>
        );

    const oldQuantityValue =
        Number(
            <?php echo json_encode((float) old('quantity_value', 0), 512) ?>
        );

    const oldQuantityUnit =
        <?php echo json_encode(old('quantity_unit', 'kg'), 512) ?>;
...
</html><?php /**PATH C:\xampp\htdocs\Allacapan_Anicare\resources\views/admin/milling/create.blade.php ENDPATH**/ ?>