...
<main class="page-wrap">
    ...
    <div class="settings-card p-4">
        ...
        <div class="status-box p-3 mb-4 d-flex justify-content-between align-items-center">
            <div>
                ...
                <div class="text-muted small">
                    <?php echo e($vatEnabled ? 'VAT will be applied.' : 'VAT is currently not applied.'); ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.reports.vat.update')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-4">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <label class="btn <?php echo e($vatEnabled ? 'btn-success' : 'btn-outline-success'); ?>">
                        <input
                            type="radio"
                            name="vat_enabled"
                            value="1"
                    ...
                    <label class="btn <?php echo e(!$vatEnabled ? 'btn-secondary' : 'btn-outline-secondary'); ?>">
                        <input
                            type="radio"
                            name="vat_enabled"
                            value="0"
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-light border">
                    Cancel
                </a>
...
<?php /**PATH C:\xampp\htdocs\Allacapan_Anicare\resources\views/admin/vat-settings.blade.php ENDPATH**/ ?>